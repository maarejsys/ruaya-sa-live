...
function search_types(latLng,search_type){
    ...
    else
    {
        ...
        if(jQuery.inArray("school", search_type) !== -1){
            var type2= 'school';
            var icon2 = "/property_website_ee/static/images/"+type2+".png";
            var request2 = {
                location: latLng,
                radius: 2000,
        ...
        if(jQuery.inArray("petrol_pump", search_type) !== -1){
            ...
            var icon13 = "/property_website_ee/static/images/"+'fuel'+".png";
            var request13 = {
                location: latLng,
                radius: 2000,
        ...
        if(jQuery.inArray("hospital", search_type) !== -1){
            var type9 = 'hospital';
            var icon9 = "/property_website_ee/static/images/"+type9+".png";
            var request9 = {
                location: latLng,
                radius: 2000,
        ...
        if(jQuery.inArray("bus_station", search_type) !== -1){
            ...
            var icon7 = "/property_website_ee/static/images/"+type7+".png";
            var request7 = {
                location: latLng,
                radius: 2000,
        ...
        if(jQuery.inArray("park", search_type) !== -1){
            var type5 = 'park';
            var icon5 = "/property_website_ee/static/images/"+type5+".png";
            var request5 = {
                location: latLng,
                radius: 2000,
        ...
        if(jQuery.inArray("bank", search_type) !== -1){
            var type4 = 'bank';
            var icon4 = "/property_website_ee/static/images/"+type4+".png";
            var request4 = {
                location: latLng,
                radius: 2000,
        ...
        if(jQuery.inArray("bar", search_type) !== -1){
            var type8 = 'bar';
            var icon8 = "/property_website_ee/static/images/"+type8+".png";
            var request8 = {
                location: latLng,
                radius: 2000,
        ...
        if(jQuery.inArray("movie_theater", search_type) !== -1){
            ...
            var icon10 = "/property_website_ee/static/images/"+type10+".png";
            var request10 = {
                location: latLng,
                radius: 2000,
        ...
        if(jQuery.inArray("night_club", search_type) !== -1){
            ...
            var icon11 = "/property_website_ee/static/images/"+type11+".png";
            var request11 = {
                location: latLng,
                radius: 2000,
        ...
        if(jQuery.inArray("zoo", search_type) !== -1){
            var type12 = 'zoo'
            var icon12 = "/property_website_ee/static/images/"+type12+".png";
            var request12 = {
                location: latLng,
                radius: 2000,
        ...
        if(jQuery.inArray("gym", search_type) !== -1){
            var type3 = 'gym';
            var icon3 = "/property_website_ee/static/images/"+type3+".png";
            var request3 = {
                location: latLng,
                radius: 2000,
        ...
        if(jQuery.inArray("atm", search_type) !== -1){
            var type = 'atm';
            var icon = "/property_website_ee/static/images/"+type+".png";
            var request = {
                location: latLng,
                radius: 2000,
        ...
        if(jQuery.inArray("spa", search_type) !== -1){
            var type6 = 'spa';
            var icon6 = "/property_website_ee/static/images/"+type6+".png";
            var request6 = {
                location: latLng,
                radius: 2000,
