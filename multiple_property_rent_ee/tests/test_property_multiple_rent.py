...
class PropertyMultipleTentTestCase(common.TransactionCase):
    ...
    def test_property_multiple(self):
        self.details = self.browse_ref(
            'property_management_ee.property_tenancy_t0')
        self.property_id1 = self.browse_ref('property_management_ee.property3')
        self.property_id2 = self.browse_ref('property_management_ee.property1')
        self.tenant_id = self.browse_ref('property_management_ee.tenant2')
        self.rent_type = self.browse_ref("property_management_ee.rent_type1")
        self.multiple_prop1 = {
